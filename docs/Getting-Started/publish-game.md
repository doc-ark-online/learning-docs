...
- 在编辑器主界面右上角点击设置按钮。
  ...
  ![编辑器设置](https://arkimg.ark.online/9204ce37-3bd8-499c-a5d5-fe67db1b3136.webp)

- 在设置界面中选中世界设置 --> 房间设置。

  ![房间设置](https://arkimg.ark.online/ae687015-1617-4148-a747-6f299645662f.webp)
...
- 在编辑器左上角点击发布按钮 --> 点击发布游戏按钮。
  ![工程中选发布游戏](https://arkimg.ark.online/b37e04d4-bd79-4d75-8387-9a06ba1b28c9.webp)
...
- 在发布游戏界面填入游戏名称、发布说明，然后按需勾选是否接入 MGS 、是否是单机模式。这里我将游戏命名为《口袋方舟启动!》，填入本次更新的说明：测试游戏。
  ...
  ![发布游戏界面](https://arkimg.ark.online/a26b1e7c-5939-4f5f-8528-112349791e6f.webp)
...
- 在编辑器主界面左上角依次点击，工程按钮 --> 更新游戏按钮。

  ![更新游戏](https://arkimg.ark.online/848a0e6a-1cb6-4861-916f-4e55f4fcab3f.webp)

- 在弹出的界面中选中要更新的游戏，这里我选择“口袋方舟启动!”这个项目，然后点击下一步按钮。

  ![选中更新游戏](https://arkimg.ark.online/4a4271f9-5509-4857-8506-5910db461495.webp)
...
在创作者后台的游戏服务里面有一个游戏配置，里面可以开关内置的关于社交服务的内容。

![image-20240924165726423](https://arkimg.ark.online/image-20240924165726423.png)

社交服务开关关闭后玩家就没法聊天沟通，也没法看到成员列表好友列表等，非必要不建议关闭。

![image-20240924170437907](https://arkimg.ark.online/image-20240924170437907.png)

如果关闭了社交服务开关，游戏中左上角的聊天图标即使点击也不会响应。

![image-20241009192213047](https://arkimg.ark.online/image-20241009192213047.png)

聊天功能则是在房间内发送公开消息的功能，私聊则是允许玩家单独私聊，一般情况默认打开的就好。

![image-20240924170632801](https://arkimg.ark.online/image-20240924170632801.png)

### 7.2 单机设置

点击工程，然后点击发布游戏后会出现发布游戏的窗口，最下面可以勾选单机游戏，**勾选后游戏模式就仅为单人，且发布后也无法再修改回多人游戏**。

| 发布游戏                                                     | 勾选单机模式                                                 |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| ![发布游戏](https://arkimg.ark.online/b37e04d4-bd79-4d75-8387-9a06ba1b28c9.webp) | ![1b731c88-c2d4-441b-ba8d-fe742113e366](https://arkimg.ark.online/1b731c88-c2d4-441b-ba8d-fe742113e366.webp) |

### 7.3 沙箱模式

在游戏发布后，点击右上角的游戏测试，即可打开测试二维码，这时候选右边的沙箱环境即可。

沙箱环境可以方便我们测试内购充值等功能，也可以在项目在线上时不影响其他的玩家进行测试。目前只推荐在沙箱测试单场景和内购等功能 。

![image-20241009165425628](https://arkimg.ark.online/image-20241009165425628.png)

详细功能可查看  [游戏测试&沙箱环境 ](https://docs.ark.online/CreatorPortal/Debug&release.html#游戏测试)