...
- 在编辑器主界面右上角点击设置按钮。
  ...
  ![编辑器设置](D:\教程图片缓存\9204ce37-3bd8-499c-a5d5-fe67db1b3136.webp)

- 在设置界面中选中世界设置 --> 房间设置。

  ![房间设置](D:\教程图片缓存\ae687015-1617-4148-a747-6f299645662f.webp)
...
- 在编辑器左上角点击发布按钮 --> 点击发布游戏按钮。
  ![工程中选发布游戏](D:\教程图片缓存\b37e04d4-bd79-4d75-8387-9a06ba1b28c9.webp)
...
- 在发布游戏界面填入游戏名称、发布说明，然后按需勾选是否接入 MGS 、是否是单机模式。这里我将游戏命名为《口袋方舟启动!》，填入本次更新的说明：测试游戏。
  ...
  ![发布游戏界面](D:\教程图片缓存\a26b1e7c-5939-4f5f-8528-112349791e6f.webp)
...
- 在编辑器主界面左上角依次点击，工程按钮 --> 更新游戏按钮。
  ...
  ![更新游戏](D:\教程图片缓存\848a0e6a-1cb6-4861-916f-4e55f4fcab3f.webp)

- 在弹出的界面中选中要更新的游戏，这里我选择“口袋方舟启动!”这个项目，然后点击下一步按钮。

  ![选中更新游戏](D:\教程图片缓存\4a4271f9-5509-4857-8506-5910db461495.webp)
...
| 发布游戏                                                     | 勾选单机模式                                                 |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| ![发布游戏](D:\教程图片缓存\b37e04d4-bd79-4d75-8387-9a06ba1b28c9.webp) | ![1b731c88-c2d4-441b-ba8d-fe742113e366](D:\教程图片缓存\1b731c88-c2d4-441b-ba8d-fe742113e366.webp) |
