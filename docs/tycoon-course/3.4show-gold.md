...
<iframe sandbox="allow-scripts allow-downloads allow-same-origin allow-popups allow-presentation allow-forms" frameborder="0" draggable="false" allowfullscreen="" allow="encrypted-media;" referrerpolicy="" aha-samesite="" class="iframe-loaded" src="//player.bilibili.com/player.html?aid=832841467&bvid=BV1fg4y197hS&cid=1316727975&p=6&autoplay=0" style="border-radius: 7px; width: 100%; height: 360px;"></iframe>
...
<iframe sandbox="allow-scripts allow-downloads allow-same-origin allow-popups allow-presentation allow-forms" frameborder="0" draggable="false" allowfullscreen="" allow="encrypted-media;" referrerpolicy="" aha-samesite="" class="iframe-loaded" src="//player.bilibili.com/player.html?aid=832841467&bvid=BV1fg4y197hS&cid=1316728317&p=7&autoplay=0" style="border-radius: 7px; width: 100%; height: 360px;"></iframe>
...
export default class BuildInfo extends Script {
     ...
     * @param unlockBtnGuid 按钮GUID // [!code focus] // [!code ++]
     */ // [!code focus] // [!code ++]
     ...
     * @param unlockBtnGuid 解锁按钮的GUID // [!code focus] // [!code ++]
     */ // [!code focus] // [!code ++]
