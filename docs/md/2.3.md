...
```typescript
@Core.Class
export default class PlayerControl extends Core.Script {/** 当脚本被实例后，会在第一帧更新前调用此函数 *///[!code focus]
...
```typescript
@Core.Class
export default class PlayerControl extends Core.Script {public speed: string = ""	//[!code focus]
...
```typescript
@Core.Class
export default class PlayerControl extends Core.Script {@Core.Property ()//[!code focus]
...
``` ts
@Core.Class
export default class PlayerControl extends Core.Script {@Core.Property ({ displayName: "移动速度"})	//[!code focus]
    public speed: string = ""
...
``` ts
@Core.Class
export default class PlayerControl extends Core.Script {@Core.Property ({ displayName: "移动速度", group: "移动设置"})//[!code focus]
    public speed: string = ""//[!code focus]
